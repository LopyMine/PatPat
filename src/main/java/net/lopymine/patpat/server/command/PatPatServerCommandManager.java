...
public class PatPatServerCommandManager {
	...
	public static void register() {
		MultiLoader.getInstance().registerOnServerStart(PatPatServerRateLimitManager::runTask);
		MultiLoader.getInstance().registerOnServerStop(PatPatServerRateLimitManager::stopTask);

		MultiLoader.getInstance().registerServerCommands((dispatcher) -> dispatcher.register(
				literal("patpat")
