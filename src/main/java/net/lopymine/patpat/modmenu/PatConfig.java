...
public class PatConfig {
	...
	private static PatCategory generateMainCategory(PatPatClientConfig config) {
		...
		return PatCategory.builder()
				...
				.addElement(PatGroup.builder()
						...
						.addOption(BooleanOption.builder()
								.name(ModMenuUtils.getOptionName("proximity_packets_list_is_blacklist"))
								.description(getDescriptionWithWarn("proximity_packets_list_is_blacklist"))
	...
	public static PatCategory generateDebugCategory(PatPatDebugConfig debugConfig) {
		...
		return PatCategory.builder()
				...
				.addElement(PatGroup.builder()
						...
						.addOption(BooleanOption.builder()
								.key("selfPat")
								.defaultValue(defDebugConfig.isSelfPat())
								.getter(debugConfig::isSelfPat)
								.setter(debugConfig::setSelfPat)
								.build()
						)
						.build()
				)
