...
public class PatPatClient {
	...
	public static final UUID SECOND_AUTHOR_UUID = UUID.fromString("192e3748-12d5-4573-a8a5-479cd394a1dc");
	public static final String CLIENT_CONFIG_VERSION = /*$ client_config_version*/ "1.0.1";
